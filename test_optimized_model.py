...
def test_optimized_model():
    ...
    try:
        ...
        test_prompts = [
            """Human: Refract my code to take as input the format of what is in the example input and output format below. Remember the first row is the number of features and the number of rows in the training data and the the last rows is the number of rows in the testing set: Sample Input
